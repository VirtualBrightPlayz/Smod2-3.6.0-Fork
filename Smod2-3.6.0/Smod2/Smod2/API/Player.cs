...
namespace Smod2.API
{
	...
	public abstract class Player : ICommandSender
	{
		...
		[Obsolete("Use GetRealHealth and GetFakeHealth.")]
		public abstract int GetHealth();
		public abstract float GetRealHealth();
		public abstract float GetFakeHealth();
		[Obsolete("Use AddHealth(float)")]
