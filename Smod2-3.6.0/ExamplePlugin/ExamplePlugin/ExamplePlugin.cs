	...
	public class ExamplePlugin : Plugin
	{
		...
		public bool GiveLottoItem(Player player)
		{
			...
			if (player.TeamRole.Team == Smod2.API.Team.SPECTATOR || 
				player.TeamRole.Team == Smod2.API.Team.NONE ||
				player.TeamRole.Team == Smod2.API.Team.SCP)
			{
				return false;
			}
			...
			Server.Map.SpawnItem(Smod2.API.ItemType.COIN, player.GetPosition(), Vector.Zero);
